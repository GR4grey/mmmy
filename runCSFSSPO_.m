function [ cum_wealth, daily_incre_fact, daily_port_total]=runCSFSSPO_(data,opts)
...
for t = 1:1:T
    ...
    %Update portfolio
     if(t<T)
       [daily_port]=CSF_fun3(data_close,data,t+1, win_size,opts);
       %idxnum=[idxnum;Imin_num];
       %asset_num = [asset_num;I_num];
     end
end
